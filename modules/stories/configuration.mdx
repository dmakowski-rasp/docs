...
description: "Each editorial has its own, specific needs, preferences and expectations regarding creating new Stories.
Content Ring allows fine-tuning what functionalities should be enabled and how should they be configured."
---
